  ...
  public static final class ModuleConstants{
   ...
   public static final class DriveConstants {
    ...
    public static final class IntakeConstants {
      ...
      public static final double kIntakeArmDownPosSetpoint = 0.8;  //converts ticks to degrees //last num is degree value to change
      public static final double kIntakeArmMidPosSetpoint = 0.9; //conv%erts ticks to degrees //last num is degree value to change
      public static final double kIntakeArmUpPosSetpoint = 1; //converts ticks to degrees //last num is degree value to change
